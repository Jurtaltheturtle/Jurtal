...
class Server {
    ...
    async handleRequest(req, res, parsedUrl) {
        try {
            ...
            const defaultLocale = (domainLocale === null || domainLocale === void 0 ? void 0 : domainLocale.defaultLocale) || ((ref3 = this.nextConfig.i18n) === null || ref3 === void 0 ? void 0 : ref3.defaultLocale);
            ...
            if (this.minimalMode && req.headers['x-matched-path'] && typeof req.headers['x-matched-path'] === 'string') {
                ...
                const matchedPathIsDataUrl = (ref5 = parsedMatchedPath.pathname) === null || ref5 === void 0 ? void 0 : ref5.includes('/_next/data');
                ...
                let srcPathname = isDataUrl ? this.stripNextDataPath(((ref6 = parsedMatchedPath.pathname) === null || ref6 === void 0 ? void 0 : ref6.replace(/\.json$/, '')) || matchedPathnameNoExt) || '/' : matchedPathnameNoExt;
                ...
                try {
                    ...
                    if (pageIsDynamic || didRewrite) {
                        ...
                        utils.normalizeVercelUrl(req, true, [
                            ...rewriteParamKeys,
                            ...Object.keys(((ref7 = utils.defaultRouteRegex) === null || ref7 === void 0 ? void 0 : ref7.groups) || {}), 
                        ]);
                    }
                } catch (err) {
    ...
    generateRoutes() {
        ...
        return {
            ...
            locales: ((ref8 = this.nextConfig.i18n) === null || ref8 === void 0 ? void 0 : ref8.locales) || []
        };
    }
   ...
   */ async handleApiRequest(req, res, pathname, query) {
    ...
    async renderToResponseWithComponents({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        const isServerComponent = !!((ref9 = components.ComponentMod) === null || ref9 === void 0 ? void 0 : ref9.__next_rsc__);
        ...
        if (opts.supportsDynamicHTML === true) {
            ...
            const isSupportedDocument = typeof ((ref13 = components.Document) === null || ref13 === void 0 ? void 0 : ref13.getInitialProps) !== 'function' || // When concurrent features is enabled, the built-in `Document`
        ...
        const locales = (ref11 = this.nextConfig.i18n) === null || ref11 === void 0 ? void 0 : ref11.locales;
        let previewData;
        ...
        resolvedUrlPathname = (0, _normalizeLocalePath).normalizeLocalePath((0, _removeTrailingSlash).removeTrailingSlash(resolvedUrlPathname), (ref12 = this.nextConfig.i18n) === null || ref12 === void 0 ? void 0 : ref12.locales).pathname;
    ...
    async renderToResponse(ctx) {
        ...
        const getOriginalappPath = (appPath)=>{
            if (this.nextConfig.experimental.appDir) {
                var ref, ref14;
                const originalappPath = ((ref = this.appPathRoutes) === null || ref === void 0 ? void 0 : ref[`${appPath}/index`]) || ((ref14 = this.appPathRoutes) === null || ref14 === void 0 ? void 0 : ref14[`${appPath}`]);
                if (!originalappPath) {
                    return null;
                }

...
function assignDefaults(userConfig) {
    ...
    if (typeof ((ref10 = userConfig.experimental) === null || ref10 === void 0 ? void 0 : ref10.reactMode) !== 'undefined') {
        var ref5;
    ...
    if (result.basePath !== '') {
        ...
        if (result.basePath !== '/') {
            ...
            if (((ref6 = result.amp) === null || ref6 === void 0 ? void 0 : ref6.canonicalBase) === '') {
    ...
    if (result === null || result === void 0 ? void 0 : result.images) {
        ...
        if (images.domains) {
            ...
            // this resource
            if ((ref9 = config.assetPrefix) === null || ref9 === void 0 ? void 0 : ref9.startsWith('http')) {
        ...
        const remotePatterns = (ref7 = result.experimental) === null || ref7 === void 0 ? void 0 : (ref8 = ref7.images) === null || ref8 === void 0 ? void 0 : ref8.remotePatterns;
        if (remotePatterns) {
    ...
    if ((ref4 = result.devIndicators) === null || ref4 === void 0 ? void 0 : ref4.buildActivityPosition) {

    ...
    createAsset(assets, compilation, context) {
        ...
        compilation.chunkGroups.forEach((chunkGroup)=>{
            function recordModule(chunk, id, mod) {
                ...
                const moduleIdMapping = manifest.__ssr_module_id__ || {};
                // Note that this isn't that reliable as webpack is still possible to assign
                // additional queries to make sure there's no conflict even using the `named`
                // module ID strategy.
                const ssrNamedModuleId = (0, _path).relative(context, mod.resourceResolveData.path);
                moduleIdMapping[id] = ssrNamedModuleId.startsWith('.') ? ssrNamedModuleId : `./${ssrNamedModuleId}`;

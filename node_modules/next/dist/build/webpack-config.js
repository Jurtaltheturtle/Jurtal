...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , hasReactRoot , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target ='server' , appDir  }) {
    var ref42, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref20, ref21, ref22, ref23, ref24;
    ...
    const getBabelOrSwcLoader = ()=>{
        ...
        if (useSWCLoader && (config === null || config === void 0 ? void 0 : (ref = config.experimental) === null || ref === void 0 ? void 0 : ref.swcTraceProfiling)) {
            ...
            ref40, ref41;
            (ref40 = require('./swc')) === null || ref40 === void 0 ? void 0 : (ref41 = ref40.initCustomTraceSubscriber) === null || ref41 === void 0 ? void 0 : ref41.call(ref40, _path.default.join(distDir, `swc-trace-profile-${Date.now()}.json`));
        }
        return useSWCLoader ? {
    ...
    const looseEsmExternals = ((ref42 = config.experimental) === null || ref42 === void 0 ? void 0 : ref42.esmExternals) === 'loose';
        ...
        plugins: [
          ...
          `
            ...
            !dev && isClient && new _telemetryPlugin.TelemetryPlugin(new Map([
                ...
                [
                    'swcEmotion',
                    !!((ref12 = config.compiler) === null || ref12 === void 0 ? void 0 : ref12.emotion)
                ],
                SWCBinaryTarget, 
            ].filter(Boolean))), 
        ].filter(Boolean)
    ...
    if ((jsConfig === null || jsConfig === void 0 ? void 0 : (ref13 = jsConfig.compilerOptions) === null || ref13 === void 0 ? void 0 : ref13.paths) && resolvedBaseUrl) {
        var ref30, ref31;
    ...
    (ref14 = webpack5Config.module) === null || ref14 === void 0 ? void 0 : (ref15 = ref14.rules) === null || ref15 === void 0 ? void 0 : ref15.unshift({
        test: /\.wasm$/,
        issuerLayer: 'middleware',
    ...
    const cache = {
        ...
        version: `${"12.1.7-canary.19"}|${configVars}`,
    ...
    if (typeof config.webpack === 'function') {
        ...
        if (((ref32 = webpack5Config.experiments) === null || ref32 === void 0 ? void 0 : ref32.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false
            };
        } else if (typeof ((ref33 = webpack5Config.experiments) === null || ref33 === void 0 ? void 0 : ref33.lazyCompilation) === 'object' && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (!config.images.disableStaticImages) {
        var ref34;
        const rules = ((ref34 = webpackConfig.module) === null || ref34 === void 0 ? void 0 : ref34.rules) || [];
    ...
    var ref35;
    const hasUserCssConfig = (ref35 = (ref24 = webpackConfig.module) === null || ref24 === void 0 ? void 0 : ref24.rules.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include)
    )) !== null && ref35 !== void 0 ? ref35 : false;
    if (hasUserCssConfig) {
        var ref36, ref37, ref38, ref39;
        ...
        if ((ref36 = webpackConfig.module) === null || ref36 === void 0 ? void 0 : ref36.rules.length) {
        ...
        if ((ref37 = webpackConfig.plugins) === null || ref37 === void 0 ? void 0 : ref37.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p)=>p.__next_css_remove !== true
            );
        }
        if ((ref38 = webpackConfig.optimization) === null || ref38 === void 0 ? void 0 : (ref39 = ref38.minimizer) === null || ref39 === void 0 ? void 0 : ref39.length) {
